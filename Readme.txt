...
4. Unit Test -> UnitTestFibonacciTest

The startup project is FibonacciWinFormTest.
The service is launch on http://localhost:3000/api/fibonacci/10 if you want fibonacci(10)
